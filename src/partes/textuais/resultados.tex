...
Parametrização normal com topologia chega a um resultado de \textit{fitness} consideravelmente rapido mas acaba falhando no teste.

neuroevolucao simples ficou proxima do neat, demorando um pouco mais para atingir \textit{fitness} maiores porem consistentemente ficando melhor a longo prazo.

Topologia inicial complexa mais sucessivel a maximo local, e evitou remover nós — mesmo assim, a topologia elevada levou a solu{\c c}{\~o}es mais inteligentes
