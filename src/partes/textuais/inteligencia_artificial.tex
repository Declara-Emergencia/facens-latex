...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.4\textwidth]{images/TS.PNG}
    \legend{
            \protect\footnotemark
            Dispon{\'i}vel em: \url{https://www.baeldung.com/cs/}. Acesso em: 3 Nov. 2022.
    }
\end{figure}
...
\begin{figure}[htb]
  ...
  \includegraphics[width=0.4\textwidth]{images/bolas.png}
  \legend{
