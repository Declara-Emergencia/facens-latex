...
A função empregada assume fórmula expressa pela Equação \ref{eq_2}, onde seu \textit{z} é substituído pelo próprio resultado da função polinomial de primeiro grau.
