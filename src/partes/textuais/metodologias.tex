...
\begin{table}[htb]
	\centering
    \caption{\label{tabela_p0}Parametrizações gerais e de reprodução.}
    \begin{tabular}{cccc}
        \hline
...
é possível observar as configurações iniciais na \autoref{tabela_p1}, a maneira da qual cada parâmetro afeta
o desempenho do algoritmo será abordada detalhadamente em capítulos posteriores.

\begin{table}[htb]
	\centering
    \caption{\label{tabela_p1}Parametrizações de genomas e redes neurais.}
    \begin{tabular}{cccc}
        \hline
		\textbf{Parâmetro} & \textbf{Valor} \\ \hline
